    ...
    <ul className="flex items-center flex-nowrap space-x-4 min-w-max certifications-slider">
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-aws-solutions_architect.png"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-aws-developer.png"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-aws-cloud_practitioner.png"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-azure-az104.png"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-azure-az900.svg"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-hashicorp-terraform.png"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-lpi-linux_essentials.png"}
      ...
      <li className="shrink-0">
        <CertificationBadge
          ...
          imageSrc={"/badge-google-it_support_professional.png"}
