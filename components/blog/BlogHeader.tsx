...
export function BlogHeader() {
  return (
    <header className="z-10 sticky top-0 w-full border-b border-border bg-accent-background/95 backdrop-blur supports-[backdrop-filter]:bg-accent-background/60">
