...
```
<Link href={"/images/blog/code_block_with_data_raw_code_property.png"}><Image src={"/images/blog/code_block_with_data_raw_code_property.png"} alt="A code block with our custom data-raw-code property" width="1763" height="438" className="max-w-2xl pr-4" /></Link>
