...
<Link href={"/new_gh_runner_connected.png"}><Image src={"/new_gh_runner_connected.png"} alt="New new self-hosted GitHub runner connected to repository" width="1567" height="443" className="max-w-2xl pr-4" /></Link>
