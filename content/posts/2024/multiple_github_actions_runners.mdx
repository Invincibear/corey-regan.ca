...
<Link href={"/images/blog/new_gh_runner_connected.png"}><Image src={"/images/blog/new_gh_runner_connected.png"} alt="New new self-hosted GitHub runner connected to repository" width="1567" height="443" className="max-w-2xl pr-4" /></Link>
